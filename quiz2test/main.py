...
def main():
    ...
    parser.add_argument('-i', '--input', help="File or folder to search for the raw documents", default=None)
    parser.add_argument('-o', '--output', help="Folder to save the output", default=None)
    ...
    parser.add_argument('-b', '--blacklist', help="Blacklist file with the excluded words or patterns", default=None)
    ...
    parser.add_argument('--use_ocr', help="Use an OCR (tesseract) to extract the text from the PDF", default=True, action='store_true')
